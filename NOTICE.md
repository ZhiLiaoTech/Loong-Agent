...
- OpenClaw source may be reused under the MIT License. Keep upstream copyright
  notices when code is copied or substantially derived.
- Hermes Agent source may be studied and reimplemented in TypeScript under the
...
that identifies its upstream origin and the nature of changes.
